        ...
        <article class="col-md-8 col-xs-12">
          <section class="home-quiz__introduction">
            <h2 class="home-quiz__introduction-h2">
               <img class="home-quiz__introduction-h2-logo" src="/images/what-is-mark.png" />ゴロタンとは?
            </h2>
            <p>簡単に英語を覚えられるように楽しくて面白い例文で覚えられる英単語のゴロとクイズのサイトです。英語学習を始める小学生、中学生から受験や旅行、ビジネスなどにも活用できます。楽しく英語を覚えていってくださいな！このサイトでは、単語の意味とその読み方と覚え方がある例文があるので、楽に英語学習ができます。</p>
          ...
          <section class="home-quiz__setting">
            ...
            <form>
              ...
              <button type="submit" class="btn btn-info" @click.stop.prevent="goQuiz()">出題開始</button>
            </form>
          </section>
