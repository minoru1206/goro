    ...
    <main>
      <div class="container">
        <div class="row">
	      ...
	      <p class="bg-warning">
              <div class="panel-heading text-center">ユーザー登録</div></p>
		  ...
		  <div class="form-group">
		      ...
		      <input type="radio" name="email_accepted" value="1" checked="checked">新着情報や通知を受け取ります。<br>
  <input type="radio" name="email_accepted" value="0">新着情報や通知を受け取りません。<br>
		  </div>
		    </div>
